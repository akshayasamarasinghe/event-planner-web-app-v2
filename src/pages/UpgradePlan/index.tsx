...
import { FiCheck, FiBriefcase, FiUser, FiAward } from 'react-icons/fi';
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex rounded-lg bg-white p-1 shadow-sm border border-gray-200">
            <button
              ...
              className={`px-6 py-3 text-sm font-medium rounded-md flex items-center ${activeTab === 'personal' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'}`}
            >
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-medium rounded-md flex items-center ${activeTab === 'business' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-gray-100'}`}
            >
