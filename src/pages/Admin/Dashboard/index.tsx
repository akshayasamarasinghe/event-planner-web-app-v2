import {Avatar, Badge, Card, Divider, Grid, Group, Paper, Progress, ScrollArea, Text, Title,} from '@mantine/core';
import {IconCalendarEvent, IconCalendarTime, IconCurrencyDollar, IconSparkles, IconUsers,} from '@tabler/icons-react';
...
export default function Dashboard() {
    ...
    return (
        <div className="container mx-auto px-6 py-8">
            ...
            <div className="grid grid-cols-span-12 gap-2">
                {/* Upcoming Events */}
