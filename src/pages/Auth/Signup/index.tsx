...
const Signup = () => {
    ...
    return (
        <div className="container mx-auto">
            {loading && <Loading/>}
            <div
                className="bg-gradient-to-r from-gray-100 to-blue-100 flex items-center justify-center px-4 py-12">
                <section
                    className="h-[850px] mx-14 rounded-3xl bg-white/60 backdrop-blur-md shadow-2xl border border-gray-200 overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                        {/* Left Form Side */}
                        <div className="h-full p-10 lg:p-16">
